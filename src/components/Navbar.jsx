  ...
  return (
    <div className='flex justify-between items-center px-4 sm:px-12 
      ...
      <img src={theme === 'dark' ? assets.logo_dark : assets.logo} 
        alt='Nexora AI logo' className='w-32 sm:w-40'/>
      <div className={`text-gray-700 dark:text-white sm:text-sm 
        ...
        <img src={assets.close_icon} alt='close button' className='w-5 absolute right-4 
        ...
        <a href='#contact-us' onClick={() => setSidebarOpen(false)} className='sm:hover:border-b sm:hidden'>Contact Us</a>
      </div>

      <div className='flex items-center gap-2 sm:gap-4'>
        <img src={theme === 'dark' ? assets.menu_icon_dark : assets.menu_icon} alt='Menu Icon'
